...
const ExpenseList: React.FC<IProps> = (props) => {
    ...
    return (
        <>
            <CTable>
                ...
                <CTableBody>
                    <>
                            ...
                            expenses.map((expense: IExpense) => (
                                <Fragment key={expense.id}>
                                    <CTableRow className="animated animate__fadeIn">
                                        ...
                                        <CTableCell>
                                            <p className="table-cell-info">
                                                {formatValue(expense.payer)}
                                            </p>
                                        </CTableCell>
                                        <CTableCell>
                                            <div>
                                        ...
                                        <CTableCell>
                                            <div className="ref-close flex justify-content--center align-items--center position--relative">
                                                <button
                                                    ...
                                                    className="btn btn--width bg--transparent font--semi-bold btn--color"
                                                    onClick={() => {
                                                        setIsSettleUp(true);
                                                        setExpenseId(
                                                            expense.id
                        ...
                        {isEmpty(expenses) && (
                            <CTableEmptyContainer
                                colSpan={ExpenseListColumns.length}
            ...
            {isSettleUp && (
                <SettleUpExpense
                    isModalOpen={isSettleUp}
                    closeModel={() => setIsSettleUp(false)}
                    expenseId={expenseId}
                />
            )}
        </>
